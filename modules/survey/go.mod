module github.com/waypointos/waypoint/modules/survey

go 1.25.0

replace github.com/waypointos/waypoint/sdk => ../../sdk
...
require (
	...
	github.com/waypointos/waypoint/sdk v0.0.0-00010101000000-000000000000
